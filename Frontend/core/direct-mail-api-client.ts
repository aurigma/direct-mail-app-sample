...
export class BuildInfoApiClient
  extends ApiClientBase
  implements IBuildInfoApiClient
{
  private http: {
    ...
    return this.transformOptions(options_)
      ...
      .then((_response: Response) => {
        return this.transformResult(url_, _response, (_response: Response) =>
          this.processHeadInfo(_response),
        );
      });
  }
...
export interface ICampaignApiClient {
  ...
  updateCampaign(
    id: string,
    body?: CampaignUpdateModel | undefined,
  ): Promise<CampaignDto>;
  ...
  implements ICampaignApiClient
{
  ...
  getCampaigns(
    ...
    return this.transformOptions(options_)
      ...
      .then((_response: Response) => {
        return this.transformResult(url_, _response, (_response: Response) =>
          this.processGetCampaigns(_response),
        );
      });
  }
  ...
  createCampaign(body: CampaignCreationModel): Promise<CampaignDto> {
    ...
    return this.transformOptions(options_)
      ...
      .then((_response: Response) => {
        return this.transformResult(url_, _response, (_response: Response) =>
          this.processCreateCampaign(_response),
        );
      });
  }
  ...
  getCampaignById(id: string): Promise<CampaignDto> {
    ...
    return this.transformOptions(options_)
      ...
      .then((_response: Response) => {
        return this.transformResult(url_, _response, (_response: Response) =>
          this.processGetCampaignById(_response),
        );
      });
  }
  ...
  updateCampaign(
    ...
    return this.transformOptions(options_)
      ...
      .then((_response: Response) => {
        return this.transformResult(url_, _response, (_response: Response) =>
          this.processUpdateCampaign(_response),
        );
      });
  }
  ...
  getCampaignTypes(): Promise<CampaignType[]> {
    ...
    return this.transformOptions(options_)
      ...
      .then((_response: Response) => {
        return this.transformResult(url_, _response, (_response: Response) =>
          this.processGetCampaignTypes(_response),
        );
      });
  }

  protected processGetCampaignTypes(
    response: Response,
...
export interface ICategoryApiClient {
   ...
   */
  createCategory(
    body?: CategoryCreationModel | undefined,
  ): Promise<CategoryDto>;
  ...
  implements ICategoryApiClient
{
  ...
  getCategories(): Promise<CategoryDto[]> {
    ...
    return this.transformOptions(options_)
      ...
      .then((_response: Response) => {
        return this.transformResult(url_, _response, (_response: Response) =>
          this.processGetCategories(_response),
        );
      });
  }
  ...
  createCategory(
    ...
    return this.transformOptions(options_)
      ...
      .then((_response: Response) => {
        return this.transformResult(url_, _response, (_response: Response) =>
          this.processCreateCategory(_response),
        );
      });
  }
  ...
  getCategory(id: string): Promise<CategoryDto> {
    ...
    return this.transformOptions(options_)
      ...
      .then((_response: Response) => {
        return this.transformResult(url_, _response, (_response: Response) =>
          this.processGetCategory(_response),
        );
      });
  }
  ...
  implements ICompanyApiClient
{
  ...
  getCompanies(): Promise<CompanyDto[]> {
    ...
    return this.transformOptions(options_)
      ...
      .then((_response: Response) => {
        return this.transformResult(url_, _response, (_response: Response) =>
          this.processGetCompanies(_response),
        );
      });
  }
  ...
  createCompany(body: CompanyCreationModel): Promise<CompanyDto> {
    ...
    return this.transformOptions(options_)
      ...
      .then((_response: Response) => {
        return this.transformResult(url_, _response, (_response: Response) =>
          this.processCreateCompany(_response),
        );
      });
  }
    ...
    if (status === 201) {
      return response.text().then((_responseText) => {
        ...
        result201 =
          _responseText === ""
            ? null
            : (JSON.parse(_responseText, this.jsonParseReviver) as CompanyDto);
        return result201;
      });
    } else if (status !== 200 && status !== 204) {
      return response.text().then((_responseText) => {
  ...
  getCompany(id: string): Promise<CompanyDto> {
    ...
    return this.transformOptions(options_)
      ...
      .then((_response: Response) => {
        return this.transformResult(url_, _response, (_response: Response) =>
          this.processGetCompany(_response),
        );
      });
  }
...
export interface IEditorApiClient {
  ...
  ): Promise<DesignValidationResultDto>;
...
export class EditorApiClient extends ApiClientBase implements IEditorApiClient {
  ...
  getIntegrationDetails(
    ...
    return this.transformOptions(options_)
      ...
      .then((_response: Response) => {
        return this.transformResult(url_, _response, (_response: Response) =>
          this.processGetIntegrationDetails(_response),
        );
      });
  }

  protected processGetIntegrationDetails(
    response: Response,
  ): Promise<IntegrationDetailsDto> {
    const status = response.status;
    let _headers: any = {};
  ...
  getEditorToken(body?: TokenRequestModel | undefined): Promise<TokenDto> {
    ...
    return this.transformOptions(options_)
      ...
      .then((_response: Response) => {
        return this.transformResult(url_, _response, (_response: Response) =>
          this.processGetEditorToken(_response),
        );
      });
  }
    ...
    if (status === 200) {
      return response.text().then((_responseText) => {
        ...
        result200 =
          _responseText === ""
            ? null
            : (JSON.parse(_responseText, this.jsonParseReviver) as TokenDto);
        return result200;
      });
    } else if (status !== 200 && status !== 204) {
      return response.text().then((_responseText) => {
  ...
  validateDesign(
    ...
    return this.transformOptions(options_)
      ...
      .then((_response: Response) => {
        return this.transformResult(url_, _response, (_response: Response) =>
          this.processValidateDesign(_response),
        );
      });
  }

  protected processValidateDesign(
    response: Response,
  ): Promise<DesignValidationResultDto> {
    const status = response.status;
    let _headers: any = {};
    ...
    if (status === 200) {
      ...
      return response.text().then((_responseText) => {
        ...
        result409 =
          _responseText === ""
            ? null
            : (JSON.parse(_responseText, this.jsonParseReviver) as ConflictDto);
        return throwException(
          "Conflict",
          status,
          _responseText,
  ...
  getAvailableVariables(
    ...
    return this.transformOptions(options_)
      ...
      .then((_response: Response) => {
        return this.transformResult(url_, _response, (_response: Response) =>
          this.processGetAvailableVariables(_response),
        );
      });
  }

  protected processGetAvailableVariables(
    response: Response,
  ): Promise<EditorVariableInfoDto[]> {
    const status = response.status;
    let _headers: any = {};
  ...
  createEditorDesign(lineItemId: string, userId: string): Promise<DesignDto> {
    ...
    if (lineItemId === undefined || lineItemId === null)
      throw new Error(
        "The parameter 'lineItemId' must be defined and cannot be null.",
      );
    else url_ += "lineItemId=" + encodeURIComponent("" + lineItemId) + "&";
    ...
    return this.transformOptions(options_)
      ...
      .then((_response: Response) => {
        return this.transformResult(url_, _response, (_response: Response) =>
          this.processCreateEditorDesign(_response),
        );
      });
  }
    ...
    if (status === 200) {
      return response.text().then((_responseText) => {
        ...
        result200 =
          _responseText === ""
            ? null
            : (JSON.parse(_responseText, this.jsonParseReviver) as DesignDto);
        return result200;
      });
    } else if (status === 400) {
      return response.text().then((_responseText) => {
...
export interface IIntegratedProductApiClient {
   ...
   * @return Success
   */
  getIntegratedProductOptions(
    id: string,
  ): Promise<IntegratedProductOptionDto[]>;
  ...
  getIntegratedProductTemplates(
    id: string,
    body?: IntegrationProductOptionRequestModel | undefined,
  ): Promise<IntegratedProductTemplateDto[]>;
  ...
  ): Promise<IntegratedProductTemplateDetailsDto>;
}

export class IntegratedProductApiClient
  extends ApiClientBase
  implements IIntegratedProductApiClient
{
  private http: {
    fetch(url: RequestInfo, init?: RequestInit): Promise<Response>;
  };
  ...
  getIntegratedProducts(
    ...
    return this.transformOptions(options_)
      ...
      .then((_response: Response) => {
        return this.transformResult(url_, _response, (_response: Response) =>
          this.processGetIntegratedProducts(_response),
        );
      });
  }

  protected processGetIntegratedProducts(
    response: Response,
  ): Promise<IntegratedProductDto[]> {
    const status = response.status;
    let _headers: any = {};
  ...
  updateIntegratedProductResources(id: string): Promise<void> {
    let url_ =
      this.baseUrl +
      "/api/direct-mail/v1/integrated-products/{id}/update-resources";
    if (id === undefined || id === null)
      throw new Error("The parameter 'id' must be defined.");
    url_ = url_.replace("{id}", encodeURIComponent("" + id));
    url_ = url_.replace(/[?&]$/, "");
    ...
    return this.transformOptions(options_)
      ...
      .then((_response: Response) => {
        return this.transformResult(url_, _response, (_response: Response) =>
          this.processUpdateIntegratedProductResources(_response),
        );
      });
  }

  protected processUpdateIntegratedProductResources(
    response: Response,
  ): Promise<void> {
    const status = response.status;
    let _headers: any = {};
  ...
  getIntegratedProductOptions(
    ...
    let url_ =
      this.baseUrl + "/api/direct-mail/v1/integrated-products/{id}/options";
    if (id === undefined || id === null)
      throw new Error("The parameter 'id' must be defined.");
    url_ = url_.replace("{id}", encodeURIComponent("" + id));
    url_ = url_.replace(/[?&]$/, "");
    ...
    return this.transformOptions(options_)
      ...
      .then((_response: Response) => {
        return this.transformResult(url_, _response, (_response: Response) =>
          this.processGetIntegratedProductOptions(_response),
        );
      });
  }

  protected processGetIntegratedProductOptions(
    response: Response,
  ): Promise<IntegratedProductOptionDto[]> {
    const status = response.status;
    let _headers: any = {};
  ...
  getIntegratedProductTemplates(
    ...
    let url_ =
      this.baseUrl + "/api/direct-mail/v1/integrated-products/{id}/templates";
    if (id === undefined || id === null)
      throw new Error("The parameter 'id' must be defined.");
    url_ = url_.replace("{id}", encodeURIComponent("" + id));
    url_ = url_.replace(/[?&]$/, "");
    ...
    return this.transformOptions(options_)
      ...
      .then((_response: Response) => {
        return this.transformResult(url_, _response, (_response: Response) =>
          this.processGetIntegratedProductTemplates(_response),
        );
      });
  }

  protected processGetIntegratedProductTemplates(
    response: Response,
  ): Promise<IntegratedProductTemplateDto[]> {
    const status = response.status;
    let _headers: any = {};
  ...
  getIntegratedProductTemplateDetails(
    ...
    let url_ =
      this.baseUrl +
      "/api/direct-mail/v1/integrated-products/{id}/templates/{templateId}?";
    if (id === undefined || id === null)
      throw new Error("The parameter 'id' must be defined.");
    url_ = url_.replace("{id}", encodeURIComponent("" + id));
    ...
    if (productVariantId === null)
      ...
      url_ +=
        "ProductVariantId=" + encodeURIComponent("" + productVariantId) + "&";
    url_ = url_.replace(/[?&]$/, "");
    ...
    return this.transformOptions(options_)
      ...
      .then((_response: Response) => {
        return this.transformResult(url_, _response, (_response: Response) =>
          this.processGetIntegratedProductTemplateDetails(_response),
        );
      });
  }

  protected processGetIntegratedProductTemplateDetails(
    response: Response,
  ): Promise<IntegratedProductTemplateDetailsDto> {
    const status = response.status;
    let _headers: any = {};
    ...
    if (status === 200) {
      return response.text().then((_responseText) => {
        ...
        result200 =
          _responseText === ""
            ? null
            : (JSON.parse(_responseText, this.jsonParseReviver) as JobDto[]);
        return result200;
      });
    } else if (status !== 200 && status !== 204) {
      return response.text().then((_responseText) => {
...
export class ApiClient extends ApiClientBase implements IApiClient {
  ...
  downloadResults(id: string): Promise<JobProcessingResultDto[]> {
    ...
    return this.transformOptions(options_)
      ...
      .then((_response: Response) => {
        return this.transformResult(url_, _response, (_response: Response) =>
          this.processDownloadResults(_response),
        );
      });
  }

  protected processDownloadResults(
    response: Response,
  ): Promise<JobProcessingResultDto[]> {
    const status = response.status;
    let _headers: any = {};
    if (response.headers && response.headers.forEach) {
      response.headers.forEach((v: any, k: any) => (_headers[k] = v));
...
export class LineItemApiClient
  extends ApiClientBase
  implements ILineItemApiClient
{
  private http: {
    fetch(url: RequestInfo, init?: RequestInit): Promise<Response>;
  };
  ...
  getLineItems(campaignId?: string | undefined): Promise<LineItemDto[]> {
    ...
    return this.transformOptions(options_)
      ...
      .then((_response: Response) => {
        return this.transformResult(url_, _response, (_response: Response) =>
          this.processGetLineItems(_response),
        );
      });
  }
  ...
  createLineItem(body: LineItemCreationModel): Promise<LineItemDto> {
    ...
    return this.transformOptions(options_)
      ...
      .then((_response: Response) => {
        return this.transformResult(url_, _response, (_response: Response) =>
          this.processCreateLineItem(_response),
        );
      });
  }
    ...
    if (status === 201) {
      return response.text().then((_responseText) => {
        ...
        result201 =
          _responseText === ""
            ? null
            : (JSON.parse(_responseText, this.jsonParseReviver) as LineItemDto);
        return result201;
      });
    } else if (status === 400) {
      return response.text().then((_responseText) => {
  ...
  getLineItem(id: string): Promise<LineItemDto> {
    ...
    return this.transformOptions(options_)
      ...
      .then((_response: Response) => {
        return this.transformResult(url_, _response, (_response: Response) =>
          this.processGetLineItem(_response),
        );
      });
  }
  ...
  updateLineItem(id: string, body: LineItemUpdateModel): Promise<LineItemDto> {
    ...
    return this.transformOptions(options_)
      ...
      .then((_response: Response) => {
        return this.transformResult(url_, _response, (_response: Response) =>
          this.processUpdateLineItem(_response),
        );
      });
  }
  ...
  finishPersonalizationLineItem(id: string): Promise<void> {
    ...
    return this.transformOptions(options_)
      ...
      .then((_response: Response) => {
        return this.transformResult(url_, _response, (_response: Response) =>
          this.processFinishPersonalizationLineItem(_response),
        );
      });
  }

  protected processFinishPersonalizationLineItem(
    response: Response,
  ): Promise<void> {
    const status = response.status;
    let _headers: any = {};
...
export interface IPreviewApiClient {
   ...
   */
  renderDesignProof(
    body?: ProofRequestModel | undefined,
   ...
   */
  renderDesignPreview(
    body?: PreviewRequestModel | undefined,
  ): Promise<FileResponse>;
   ...
   * @return Success
   */
  downloadProofsArchive(
    body?: ProofsZipRequestModel | undefined,
  ): Promise<FileResponse>;
}

export class PreviewApiClient
  extends ApiClientBase
  implements IPreviewApiClient
{
  private http: {
    fetch(url: RequestInfo, init?: RequestInit): Promise<Response>;
  };
  ...
  getDesignInfo(lineItemId?: string | undefined): Promise<DesignInfoDto> {
    ...
    return this.transformOptions(options_)
      ...
      .then((_response: Response) => {
        return this.transformResult(url_, _response, (_response: Response) =>
          this.processGetDesignInfo(_response),
        );
      });
  }
  ...
  renderDesignProof(
    ...
    return this.transformOptions(options_)
      ...
      .then((_response: Response) => {
        return this.transformResult(url_, _response, (_response: Response) =>
          this.processRenderDesignProof(_response),
        );
      });
  }

  protected processRenderDesignProof(
    response: Response,
  ): Promise<FileResponse> {
    const status = response.status;
    let _headers: any = {};
  ...
  renderDesignPreview(
    ...
    return this.transformOptions(options_)
      ...
      .then((_response: Response) => {
        return this.transformResult(url_, _response, (_response: Response) =>
          this.processRenderDesignPreview(_response),
        );
      });
  }

  protected processRenderDesignPreview(
    response: Response,
  ): Promise<FileResponse> {
    const status = response.status;
    let _headers: any = {};
  ...
  downloadProofsArchive(
    ...
    return this.transformOptions(options_)
      ...
      .then((_response: Response) => {
        return this.transformResult(url_, _response, (_response: Response) =>
          this.processDownloadProofsArchive(_response),
        );
      });
  }

  protected processDownloadProofsArchive(
    response: Response,
  ): Promise<FileResponse> {
    const status = response.status;
    let _headers: any = {};
  ...
  implements IProductApiClient
{
  ...
  getProducts(categoryId?: string | undefined): Promise<ProductDto[]> {
    ...
    return this.transformOptions(options_)
      ...
      .then((_response: Response) => {
        return this.transformResult(url_, _response, (_response: Response) =>
          this.processGetProducts(_response),
        );
      });
  }
  ...
  createProduct(body: ProductCreationModel): Promise<ProductDto> {
    ...
    return this.transformOptions(options_)
      ...
      .then((_response: Response) => {
        return this.transformResult(url_, _response, (_response: Response) =>
          this.processCreateProduct(_response),
        );
      });
  }
  ...
  getProduct(id: string): Promise<ProductDto> {
    ...
    return this.transformOptions(options_)
      ...
      .then((_response: Response) => {
        return this.transformResult(url_, _response, (_response: Response) =>
          this.processGetProduct(_response),
        );
      });
  }
...
export interface IRecipientListApiClient {
   ...
   * @return Success
   */
  submitRecipientLists(
    body?: RecipientListSubmitModel | undefined,
  ): Promise<RecipientListDto[]>;
}

export class RecipientListApiClient
  extends ApiClientBase
  implements IRecipientListApiClient
{
  private http: {
    fetch(url: RequestInfo, init?: RequestInit): Promise<Response>;
  };
  ...
  getRecipientLists(): Promise<RecipientListDto[]> {
    ...
    return this.transformOptions(options_)
      ...
      .then((_response: Response) => {
        return this.transformResult(url_, _response, (_response: Response) =>
          this.processGetRecipientLists(_response),
        );
      });
  }

  protected processGetRecipientLists(
    response: Response,
  ): Promise<RecipientListDto[]> {
    const status = response.status;
    let _headers: any = {};
  ...
  submitRecipientLists(
    ...
    return this.transformOptions(options_)
      ...
      .then((_response: Response) => {
        return this.transformResult(url_, _response, (_response: Response) =>
          this.processSubmitRecipientLists(_response),
        );
      });
  }

  protected processSubmitRecipientLists(
    response: Response,
  ): Promise<RecipientListDto[]> {
    const status = response.status;
    let _headers: any = {};
